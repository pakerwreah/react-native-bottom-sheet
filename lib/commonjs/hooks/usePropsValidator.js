...
const usePropsValidator = ({
  ...
  (0, _react.useMemo)(() => {
    ...
    (0, _invariant.default)(typeof android_bottomTabBarHeight === 'number' || typeof android_bottomTabBarHeight === 'undefined', `'android_bottomTabBarHeight' was provided but with wrong type ! expected type is a number.`);
    //#endregion
